...
// Gradient themes for teams
export const gradients = {
  breeze: 'bg-gradient-to-br from-sky-200 via-blue-300 to-indigo-400',
  sunset: 'bg-gradient-to-br from-orange-400 via-pink-500 to-purple-500',
  emerald: 'bg-gradient-to-br from-emerald-400 via-green-500 to-teal-600',
}

// Teams data for account switcher
export const teams = [
  {
    name: "Stashd",
    logo: Icons.stash,
  ...
  export const accounts = [
    {
      ...
      icon: (
        <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <title>Vercel</title>
          <path d="M24 22.525H0l12-21.05 12 21.05z" fill="text-muted-foreground" />
        </svg>
      ),
    },
    {
